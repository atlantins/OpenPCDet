    ...
    def get_infos(self, num_workers=4, has_label=True, count_inside_pts=True, sample_id_list=None):
        ...
        def process_single_scene(sample_idx):
            ...
            if has_label:
                ...
                # 计算有效物体的个数，如10个，object减去“DontCare”4个，还剩num_objects6个
...
if __name__ == '__main__':
    ...
    if sys.argv.__len__() > 1 and sys.argv[1] == 'create_kitti_infos':
        ...
        create_kitti_infos(
            ...
            data_path=ROOT_DIR / 'data' / 'kitti'/'test_minikitti',  # OpenPCDet/data/kitti
            save_path=ROOT_DIR / 'data' / 'kitti' /'test_minikitti'  # OpenPCDet/data/kitti
        )
